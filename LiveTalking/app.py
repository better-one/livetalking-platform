...
def main():
    ...
    # 注册 avatar 管理 API
    from server.avatar_api import setup_avatar_routes
    setup_avatar_routes(appasync)

    # 注册系统信息和视频 API
    from server.system_api import setup_system_routes
    setup_system_routes(appasync)

    # 注册名人聊天 API
    from server.celebrity_api import setup_celebrity_routes
    setup_celebrity_routes(appasync)

    # 注册 LLM 配置 API
    from server.llm_api import setup_llm_routes
    setup_llm_routes(appasync)
